			...
			<div class="col-12 col-lg-8 d-none d-lg-block ">
				<div class="row h-100 position-relative about__box-images">
					<div class="p-0 col-7 about__box-img position-absolute">
						<picture>
							<source srcset="<?= SITE_TEMPLATE_PATH; ?>/images/about.webp" type="image/webp"><img src="<?= SITE_TEMPLATE_PATH; ?>/images/about.png" alt="" class="w-100 h-100" width="490" height="380" />
						</picture>
					</div>
					<div class="p-0 col-5 about__box-img position-absolute">
						<picture>
							<source srcset="<?= SITE_TEMPLATE_PATH; ?>/images/about2.webp" type="image/webp"><img src="<?= SITE_TEMPLATE_PATH; ?>/images/about2.png" alt="" class="w-100 h-100" width="295" height="260" />
						</picture>
					</div>
					<div class="p-0 col-5 about__box-img position-absolute">
						<picture>
							<source srcset="<?= SITE_TEMPLATE_PATH; ?>/images/about1.webp" type="image/webp"><img src="<?= SITE_TEMPLATE_PATH; ?>/images/about1.png" alt="" class="w-100 h-100" width="310" height="200" />
						</picture>
					</div>
					<div class="p-0 col-7 about__box-img position-absolute">
						<picture>
							<source srcset="<?= SITE_TEMPLATE_PATH; ?>/images/about3.webp" type="image/webp"><img src="<?= SITE_TEMPLATE_PATH; ?>/images/about3.png" alt="" class="w-100 h-100" width="525" height="368" />
						</picture>
					</div>
				</div>
			</div>
