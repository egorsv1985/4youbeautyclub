			...
			<div class="col-6">
				<div class=" products__slider slider position-relative">
					<div class="slider__item">
						<div class="row g-4">
							<div class="col-6 ">
								<img src="<?= SITE_TEMPLATE_PATH; ?>/images/medicines_logo1.png" alt="Препараты">
							</div>
							<div class="col-6 ">
								<img src="<?= SITE_TEMPLATE_PATH; ?>/images/medicines_logo2.png" alt="Препараты">
							</div>
							<div class="col-6 ">
								<img src="<?= SITE_TEMPLATE_PATH; ?>/images/medicines_logo3.png" alt="Препараты">
							</div>
							<div class="col-6 ">
								<img src="<?= SITE_TEMPLATE_PATH; ?>/images/medicines_logo4.png" alt="Препараты">
							</div>
						</div>
					</div>
					<div class="slider__item">
